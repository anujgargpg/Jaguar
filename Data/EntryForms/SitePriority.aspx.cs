...
public partial class _BucketMstr : System.Web.UI.Page
{
    ...
    private void GetMaster()
    {
        ...
        for (int i = 0; Ds.Tables[0].Rows.Count > i; i++)
        {
            ...
            else if (Ds.Tables[0].Rows[i]["NodeType"].ToString() == "130")
    ...
    [System.Web.Services.WebMethod()]
    public static string fnGetReport(string UserID, string LoginID, string RoleID, string MonthVal, string YearVal)
    {
        try
        {
            ...
            Scmd.Parameters.AddWithValue("@USerID", UserID);
            Scmd.Parameters.AddWithValue("@LLOginID", LoginID);
            Scmd.Parameters.AddWithValue("@ROleID", RoleID);
            ...
            return "0|^|" + CreateSitePriorityTbl(Ds, "Report");
        }
        catch (Exception ex)
        {
            return "1|^|" + ex.Message;
    ...
    private static string CreateSitePriorityTbl(DataSet Ds, string RptName)
    {
        ...
        sb.Append("<thead>");
        sb.Append("<tr>");
        sb.Append("<th style='display: none;'><input type='checkbox' onclick='fnChkAll(this);'/></th>");
        ...
        if (Ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0; i < Ds.Tables[0].Rows.Count; i++)
            {
                ...
                sb.Append("<td iden='sitepriority' style='display: none;'></td>");
                ...
                sb.Append("<td iden='sitepriority' class='cls-td-Action'><img src='../../Images/edit.png' title='Edit' onclick='fnEditCopy(this, 1);'/></td>");
    ...
    public static string fnSave(string LoginID, string UserID, string RoleID, string MonthVal, string YearVal, string SWPNormID, object objLocation, object objChannel, object objSBF, string flgSaveSubmit)
    {
        try
        {
            ...
            Scmd.Parameters.AddWithValue("@flgSaveSubmit", flgSaveSubmit);
            Scmd.Parameters.AddWithValue("@MonthVal", MonthVal);
            Scmd.Parameters.AddWithValue("@YearVal", YearVal);
