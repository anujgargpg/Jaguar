<%@ Page Title="" Language="C#" MasterPageFile="~/Data/MasterPages/site.master" AutoEventWireup="true" CodeFile="SBDApproval.aspx.cs" Inherits="_SBDMstr" ValidateRequest="true" %>
    ...
    <script type="text/javascript">
                ...
                if (ArrSBD.length == 0) {
                    ...
                    switch (flgAction.toString()) {
                        case "4":       //Send for Approval
                            $("#divConfirm").html("<div style='font-size: 0.9rem; font-weight: 600; text-align: center;'>You are going to send <span style='color:#0000ff; font-weight: 700;'>" + ArrSBD.length + "</span> SBD(s) for Approval.<br/>Do you want to continue ?</div>");
                            break;
                        case "6":       //Approved
                            ...
                            break;
                        case "7":       //Reject
                            $("#divConfirm").html("<div style='font-size: 0.9rem; font-weight: 600; text-align: center;'>You are going to Reject <span style='color:#0000ff; font-weight: 700;'>" + ArrSBD.length + "</span> SBD(s).<br/>Do you want to continue ?</div>");
                            break;
        ...
        function fnSaveFinalAction_pass(res, flgAction) {
            if (res.split("|^|")[0] == "0") {
                switch (flgAction) {
                    case "6":
                        AutoHideAlertMsg("SBD(s) send for approval !");
                        break;
                    case "7":
                        AutoHideAlertMsg("SBD(s) approved successfully !");
                        break;
                    case "8":
                        AutoHideAlertMsg("SBD(s) rejected !");
                        break;
                    case "9":
                        AutoHideAlertMsg("SBD(s) mark as released !");
                        break;
                    default:
    ...
    <div class="row no-gutters" style="margin-top: -10px;">
        <div class="fsw col-12" id="Filter">
            <div class="fsw_inner">
                ...
                <div class="fsw_inputBox" id="divHierFilterBlock" style="width: 46%;">
                    <div class="row">
                ...
                <div class="fsw_inputBox" id="divTypeSearchFilterBlock" style="width: 37%; ">
