<%@ Page Title="" Language="C#" MasterPageFile="~/Data/MasterPages/site.master" AutoEventWireup="true" CodeFile="SBDExtract.aspx.cs" Inherits="SBDExtractInLeap" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fnDownloadCSVExtractReport(flg) {
            ...
            $("#dvloader").show();
            PageMethods.fnDownloadCSVExtractReport(LoginID, RoleID, UserID, ProdValues, LocValues, ChannelValues, ProcessGroup, ArrUser, Qtr, Yr, flgIncludeReleased, ReleaseID, fnDownloadCSVExtractReport_pass, fnfailed, flg);
        }
        function fnDownloadCSVExtractReport_pass(res, flg) {
            if (res.split("|^|")[0] == "0") {
                ...
                $("#divConfirm").html("<div style='width: 99%; text-align: center; color: #044d91; font-size: 1rem; font-weight: 600;'>Please wait, download will start shortly ... </div>");
                $("#divConfirm").dialog({
                    "modal": true,
                    "width": "320",
                    "height": "170",
    ...
    <div class="row no-gutters" style="margin-top: -10px;">
        <div class="fsw col-12" id="Filter">
            <div class="fsw_inner">
                ...
                <div class="fsw_inputBox pr-0" style="width: 28%;">
                    ...
                    <div class="d-block">
                        ...
                        <select id="ddlReleaseCycle" class="form-control form-control-sm" style="width: 150px; display: inline-block;" disabled></select>
                    </div>
                </div>
                ...
                <div class="fsw_inputBox pr-0" id="divHierFilterBlock" style="width: 27%;">
                    ...
                    <div class="d-block">
                        ...
                        <a id="txtChannelHierSearch" class="btn btn-primary btn-sm" href="#" buckettype="3" prodlvl="210" prodhier="" onclick="fnShowProdHierPopup(this, 0);" title="Channel Filter" style="margin-right: 4%;">Channel</a>
                        <a id="btnReset" class="btn btn-primary btn-sm" href="#" onclick="fnResetFilter();" title="Reset All Filters">Reset Filter</a>
                    </div>
                </div>
                <div class="fsw_inputBox pr-0" id="divDwnldBtnBlock" style="width: 13%;">
                    <div class="fsw-title">&nbsp;</div>
                    <a id="btnShowRpt" class="btn btn-primary btn-sm" href="#" onclick="fnDownloadCSVExtractReport(0);" title="Download Focus Brand Extract">Download Extract</a>
                </div>
            </div>
        </div>
    </div>
