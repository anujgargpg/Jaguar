...
public partial class _FocusBrand : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                ...
                if (Utilities.ValidateRoleBasedAccess(hdnRoleID.Value, "71"))
                    GetMaster();
                else
                    Response.Redirect("~/frmLogin.aspx");
            }
    ...
    {
        hdnProductLvl.Value = "<div class='producthrchy'>Product Level</div>" + Utilities.GetHierLvl("1", hdnLoginID.Value, hdnUserID.Value, hdnRoleID.Value, hdnNodeID.Value, hdnNodeType.Value, "71");

        hdnLocationLvl.Value = "<div class='producthrchy'>Location Level</div>" + Utilities.GetHierLvl("2", hdnLoginID.Value, hdnUserID.Value, hdnRoleID.Value, hdnNodeID.Value, hdnNodeType.Value, "71");

        hdnChannelLvl.Value = "<div class='producthrchy'>Channel Level</div>" + Utilities.GetHierLvl("3", hdnLoginID.Value, hdnUserID.Value, hdnRoleID.Value, hdnNodeID.Value, hdnNodeType.Value, "71");
        ...
        Scmd.CommandText = "spFBGetFBMatser_New";
    ...
    public static string fnProdHier(string LoginID, string UserID, string RoleID, string UserNodeID, string UserNodeType, string ProdLvl, string flg, object obj)
    {
        try
        {
            ...
            if (tbl.Rows.Count > 0)
            {
                return "0|^|" + Utilities.GetHierDetail("1", LoginID, UserID, RoleID, UserNodeID, UserNodeType, ProdLvl, "71") + "|^|" + Utilities.GetSelectedHierDetail("1", obj, "71");
            }
            else
                return "0|^|" + Utilities.GetHierDetail("1", LoginID, UserID, RoleID, UserNodeID, UserNodeType, ProdLvl, "71") + "|^|";
        }
        catch (Exception ex)
        {
            return "1|^|" + ex.Message;
    ...
    public static string fnLocationHier(string LoginID, string UserID, string RoleID, string UserNodeID, string UserNodeType, string ProdLvl, object obj, string InSubD)
    {
        try
        {
            ...
            if (tbl.Rows.Count > 0)
            {
                return "0|^|" + Utilities.GetHierDetail("2", LoginID, UserID, RoleID, UserNodeID, UserNodeType, ProdLvl, "71") + "|^|" + Utilities.GetSelectedHierDetail("2", obj, "71");
            }
            else
                return "0|^|" + Utilities.GetHierDetail("2", LoginID, UserID, RoleID, UserNodeID, UserNodeType, ProdLvl, "71") + "|^|";
        }
        catch (Exception ex)
        {
            return "1|^|" + ex.Message;
    ...
    public static string fnChannelHier(string LoginID, string UserID, string RoleID, string UserNodeID, string UserNodeType, string ProdLvl, object obj)
    {
        try
        {
            ...
            if (tbl.Rows.Count > 0)
            {
                return "0|^|" + Utilities.GetHierDetail("3", LoginID, UserID, RoleID, UserNodeID, UserNodeType, ProdLvl, "71") + "|^|" + Utilities.GetSelectedHierDetail("3", obj, "71");
            }
            else
                return "0|^|" + Utilities.GetHierDetail("3", LoginID, UserID, RoleID, UserNodeID, UserNodeType, ProdLvl, "71") + "|^|";
        }
        catch (Exception ex)
        {
            return "1|^|" + ex.Message;
    ...
    {
        return Utilities.GetBucketDetailsbasedonType(BucketType, LoginID, UserID, RoleID, Month, Year, true, "71");
    }

    [System.Web.Services.WebMethod()]
    public static string GetBucketbasedonType(string LoginID, string RoleID, string UserID, string BucketType)
    {
        return Utilities.GetBucketDetailsbasedonType(BucketType, LoginID, UserID, RoleID, "", "", false, "71");
    }
    [System.Web.Services.WebMethod()]
    public static string GetSelHierTbl(object obj, string BucketType, string InSubD)
    {
        return Utilities.GetSelectedHierDetail(BucketType, obj, "71");
    }
    ...
    public static string fnGetReport(string LoginID, string RoleID, string UserID, string FromDate, string ToDate, object objProd, object objLoc, object objChannel, string ProcessGroup, object objUser)
    {
        try
        {
            ...
            Scmd = new SqlCommand();
            Scmd.Connection = Scon;
            Scmd.CommandText = "spFBGetFBInfo_NEW";
            Scmd.Parameters.AddWithValue("@LoginID", LoginID);
    ...
    public static string fnGetAllRejectComments(string RoleID, string LoginID, string UserID, object objINIT)
    {
        try
        {
            ...
            Scmd = new SqlCommand();
            Scmd.Connection = Scon;
            Scmd.CommandText = "spFBGetCommentsinBulk_New";
    ...
    public static string fnGetRejectComments(string INITID, string RoleID)
    {
        try
        {
            ...
            Scmd = new SqlCommand();
            Scmd.Connection = Scon;
            Scmd.CommandText = "spFBGetComment_New";
    ...
    public static string fnSaveRejectComments(string INITID, string RoleID, string UserID, string LoginID, string Comments)
    {
        try
        {
            ...
            Scmd = new SqlCommand();
            Scmd.Connection = Scon;
            Scmd.CommandText = "spFBSaveComment_New";
            Scmd.Parameters.AddWithValue("@FBID", INITID);
            Scmd.Parameters.AddWithValue("@RoleID", RoleID);
            Scmd.Parameters.AddWithValue("@UserID", UserID);
            Scmd.Parameters.AddWithValue("@LoginID", LoginID);
    ...
    public static string fnManageBookMark(string flgBookmark, string LoginID, string UserID, object objINIT)
    {
        try
        {
            ...
            Scmd = new SqlCommand();
            Scmd.Connection = Scon;
            Scmd.CommandText = "spFBManageBookmark_New";
    ...
    public static string fnSettle(string INITID, string UserID, string LoginID)
    {
        try
        {
            ...
            Scmd = new SqlCommand();
            Scmd.Connection = Scon;
            Scmd.CommandText = "spFBMarkSetteled_New";
            Scmd.Parameters.AddWithValue("@FBID", INITID);
            Scmd.Parameters.AddWithValue("@UserID", UserID);
            Scmd.Parameters.AddWithValue("@LoginID", LoginID);
            Scmd.CommandType = CommandType.StoredProcedure;
    ...
    public static string fnSave(string INITID, string INITName, string FBShortDescr, string INITDescription, string FromDate, string ToDate, object objBucket, object obj, string LoginID, string strLocation, string strChannel, string IncudeLeap, string IncudeSubD, object objProd, string UserID, string flgSave, object objClusterDetails, object objAllSKU, object objTopSKU, object objSector)
    {
        try
        {
            ...
            if (flgTopSKU == 1)
            {
                SqlCommand Scmd = new SqlCommand();
                Scmd.Connection = Scon;
                Scmd.CommandText = "spFBManageFB_New";
                Scmd.CommandType = CommandType.StoredProcedure;
                Scmd.Parameters.AddWithValue("@FBID", INITID);
    ...
    public static string fnDeleteInitiative(string INITID, string UserID)
    {
        try
        {
            ...
            for (int i = 0; i < INITID.Split('^').Length; i++)
            {
                Scmd = new SqlCommand();
                Scmd.Connection = Scon;
                Scmd.CommandText = "spFBDelete_New";
    ...
    public static string fnSaveFinalAction(string RoleID, string LoginID, string UserID, object objINIT)
    {
        try
        {
            ...
            Scmd = new SqlCommand();
            Scmd.Connection = Scon;
            Scmd.CommandText = "spFBSaveSubmitFB_New";
            Scmd.Parameters.AddWithValue("@RoleID", RoleID);
            Scmd.Parameters.AddWithValue("@LoginID", LoginID);
            Scmd.Parameters.AddWithValue("@UserID", UserID);
    ...
    protected void btnDownload_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand Scmd = new SqlCommand();
        Scmd.Connection = Scon;
        Scmd.CommandText = "[spFBExtractSelected_New]";
        Scmd.CommandType = CommandType.StoredProcedure;
        Scmd.CommandTimeout = 0;
