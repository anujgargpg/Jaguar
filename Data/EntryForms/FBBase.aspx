<%@ Page Title="" Language="C#" MasterPageFile="~/Data/MasterPages/site.master" AutoEventWireup="true" CodeFile="FBBase.aspx.cs" Inherits="_FocusBrand" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="../../Scripts/js_FBMstrBase.js"></script>
            ...
            <div class="fsw_inner">
                ...
                <div class="fsw_inputBox" id="divAddNewFilterBlock" style="width: 13%; padding: 6px 2px 0 6px;">
                    ...
                    <div class="d-block">
                        ...
                        <a href="##" class="btn btn-primary btn-sm" id="btnCopyINIT" onclick="fnFBImportPopup(0,2,1);" title="Import Focus Brand from previous month to current month" style="margin-left: 1%;"><i class="fa fa-clone"></i>&nbsp; Import</a>
                    </div>
                </div>
            </div>
        </div>
