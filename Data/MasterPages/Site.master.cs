...
public partial class Data_MasterPages_SiteMenu : System.Web.UI.MasterPage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            hdnMasterRoleID.Value = Session["RoleId"].ToString();
    ...
    private void PopulateTopMenuHierarch(string loginValue)
    {
        ...
        sqlPara.Add("MenuNode","0");
        sqlPara.Add("LoginID", loginValue);
        DataSet ds = DBHelper.ExecuteDataSet("spMakeTreeMenu", sqlPara);
