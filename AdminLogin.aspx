<%@ Page Language="C#" AutoEventWireup="false" CodeFile="AdminLogin.aspx.cs" Inherits="AdminLogin" %>
                    ...
                    <div class="loginfrm cls-4">
                        <div class="login-box">
                            ...
                            <div class="text-center error_msg">
                                <span id="dvMessage" runat="server" class="label label-danger labeldanger"></span>
                            </div>
                            <div class="login-box-footer clearfix">
                                <asp:Button ID="btnSubmit" Text="Login" CssClass="btns btn-submit w-100" runat="server" OnClientClick="return fnValidate();" OnClick="btnSubmit_Click" />
                            </div>
                        </div>
                    </div>
                </div>
