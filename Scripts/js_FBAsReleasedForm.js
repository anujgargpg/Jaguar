...
function fnGetReport(flg) {
    ...
    $("#dvloader").show();
    PageMethods.fnGetReport(LoginID, RoleID, UserID, FBType, ProdValues, LocValues, ChannelValues, ProcessGroup, ArrUser, Qtr, Yr, fnGetReport_pass, fnfailed, flg);
}
            ...
            $("#divConfirm").dialog({
                ...
                buttons: [{
                    ...
                    click: function () {
                        ...
                        $("#dvloader").show();
                        PageMethods.fnSaveFinalAction(RoleID, LoginID, UserID, FBType, ArrSBD, fnSaveFinalAction_pass, fnfailed, flgAction);
                    }
                },
                {
                    text: 'No',
