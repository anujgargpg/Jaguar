...
function fnDownload() {
    ...
    var $form = $("<form/>").attr("id", "data_form")
        .attr("action", "LeapWinITHandler.ashx")
        .attr("method", "post")
        .attr("target", "_blank");
    $("body").append($form);

    //Append the values to be send
    AddParameter($form, "LoginId", LoginID);
    AddParameter($form, "objProd", PrdString);
    AddParameter($form, "objLoc", LocString);
    AddParameter($form, "objChannel", ChannelString);
    AddParameter($form, "fromdate", fromdate);
    AddParameter($form, "todate", todate);
    AddParameter($form, "user", UserID);
    AddParameter($form, "objStage", StageValues);
    AddParameter($form, "role", RoleID);
    AddParameter($form, "flgPage", flgPage);
    AddParameter($form, "flgInstance", flgInstance);
    AddParameter($form, "objMSMP", MSMPValues);
    AddParameter($form, "objINITType", ArrInitType);
    $form[0].submit();


    //var data = new FormData();
    //data.append("LoginId", LoginID);
    //data.append("objProd", PrdString);
    //data.append("objLoc", LocString);
    //data.append("objChannel", ChannelString);
    //data.append("fromdate", fromdate);
    //data.append("todate", todate);
    //data.append("user", UserID);
    //data.append("objStage", StageValues);
    //data.append("role", RoleID);
    //data.append("flgPage", flgPage);
    //data.append("flgInstance", flgInstance);
    //data.append("objMSMP", MSMPValues);
    //data.append("objINITType", ArrInitType);

    //$("#dvloader").show();
    //$.ajax({
    //    url: "LeapWinITHandler.ashx",
    //    type: "POST",
    //    data: data,
    //    async: true,
    //    contentType: false,
    ...
    //$("#dvloader").show();
    //PageMethods.GetDownloadReport(LoginID, ProdValues, LocValues, ChannelValues, fromdate, todate, UserID, StageValues, RoleID, flgPage, flgInstance, MSMPValues, ArrInitType, GetDownloadReport_pass, GetDownloadReport_failed);
}
